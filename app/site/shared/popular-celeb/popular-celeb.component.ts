...
@Component({
    selector: 'popular-celeb',
    templateUrl: './popular-celeb.component.html',
    styleUrls: ['./popular-celeb.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PopularGridComponent {
  ...
  private loadPeople(reload = false) {      
      ...
      this.people.getAll({perPage: 10, page, topRated: true, order: ""})          
          .subscribe(response => {
