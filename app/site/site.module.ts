...
import {SearchPersonInputComponent} from './search/search-person-input/search-person-input.component';
...
import {TitleGridComponent} from './shared/title-grid/title-grid.component';
import {PopularGridComponent} from './shared/popular-celeb/popular-celeb.component';
...
import {SingleRangeSliderComponent} from './shared/single-range-slider/single-range-slider.component';
...
import {MetaPersonState} from '../admin/people-page/meta-person-page/state/meta-person-state';
...
import { MultipleDemoComponent } from './shared/multiple-demo/multiple-demo.component';
import { SitePopupComponent } from './shared/site-popup/site-popup.component';
import { SuggestUpdateComponent } from './suggest-update/suggest-update.component';
import { DialogOverviewExample,DialogOverviewExampleDialog} from './dialog-overview-example/dialog-overview-example';
import { UserRatingWidgetComponent } from './people/user-rating-widget/user-rating-widget.component';
import { ThankYouComponent } from './thank-you/thank-you.component';
import { RecentlyRatedCelebComponent } from './shared/recently-rated-celeb/recently-rated-celeb.component';
...
@NgModule({
    imports: [
        ...
        AdsenseModule.forRoot({
            adClient: 'ca-pub-9994502427075733',
            adSlot: 1590382646
        }),
        // state
    ...
    declarations: [
        ...
        DialogOverviewExampleDialog, UserRatingWidgetComponent, ThankYouComponent, RecentlyRatedCelebComponent, MoreInfoComponent,
    ],
    entryComponents: [
        StarRatingOverlayComponent,
        CrupdateReviewModalComponent,
