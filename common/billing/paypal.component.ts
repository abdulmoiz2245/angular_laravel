...
export class NgxPaypalComponent implements OnChanges,OnDestroy, AfterViewInit {
    ...
    protected payPalButtonContainerElem?: ElementRef;
     ...
     */
    protected initializePayPal: boolean = true;
    ...
    constructor(
        protected paypalScriptService: PayPalScriptService,
    ...
    protected initPayPalScript(config: IPayPalConfig, initPayPal: (paypal: any) => void): void {
    ...
    protected initPayPal(config: IPayPalConfig, paypal: any): void {
...
@Component({
    changeDetection: ChangeDetectionStrategy.OnPush,
    selector: 'ngx-paypal2',
    template: `
    <div #payPalButtonContainer [id]="payPalButtonContainerId"></div>
    `
})

export class NgxPaypalComponent2 extends NgxPaypalComponent {

    @Input() registerScript: boolean = false;
